    ...
    getElementType: function(){
	    ...
	    switch(true){
		 ...
		 case (nn == 'INPUT' && nt == 'URL'):
			return LiveValidation.TEXT; 
		 case (nn == 'INPUT' && nt == 'TIME'):
			return LiveValidation.TEXT; 
		 case (nn == 'INPUT' && nt == 'SEARCH'):
			return LiveValidation.TEXT; 
		 case (nn == 'INPUT' && nt == 'DATETIME'):
			return LiveValidation.TEXT; 
		 case (nn == 'INPUT' && nt == 'DATETIME-LOCAL'):
			return LiveValidation.TEXT; 
		 case (nn == 'INPUT' && nt == 'COLOR'):
			return LiveValidation.TEXT; 
		 case (nn == 'INPUT' && nt == 'WEEK'):
			return LiveValidation.TEXT; 
		 case (nn == 'INPUT' && nt == 'RANGE'):
			return LiveValidation.TEXT; 
